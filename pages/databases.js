...
export default function DatabasesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a2540] text-white px-4 py-12">
      <h1 className="text-3xl font-bold mb-10 text-center">LeakWhat - Available Data Providers</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-6xl mx-auto">
        {databases.map((db, index) => (
          <div key={index} className="bg-gray-800 rounded-2xl shadow-md p-6">
